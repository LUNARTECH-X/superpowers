...
description: "Generate professional clinical decision support (CDS) documents for pharmaceutical and clinical research settings. Use when creating patient cohort analyses with biomarker stratification, treatment recommendation reports with GRADE evidence grading, or clinical decision algorithms. Supports statistical analysis (hazard ratios, survival curves, waterfall plots), biomarker integration, and regulatory compliance with publication-ready LaTeX/PDF output."
...
Include 1-2 AI-generated figures per document using the **scientific-schematics** skill (e.g., clinical decision algorithms, treatment pathway diagrams, biomarker stratification trees, CONSORT-style patient flow diagrams). Generate via:
