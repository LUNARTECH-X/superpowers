---
name: latex-posters
description: "Create professional research posters in LaTeX using beamerposter, tikzposter, or baposter. Use when preparing conference posters, academic presentations, or visual research summaries. Includes layout design, color schemes, multi-column formats, figure integration, compilation workflows, and poster-specific best practices for visual communication."
...
Include 2-3 AI-generated figures per poster using the **scientific-schematics** skill. Figures should occupy 40-50% of poster area. Generate via:
