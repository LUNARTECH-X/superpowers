...
description: "Comprehensive citation management for academic research. Use when searching Google Scholar and PubMed for papers, extracting accurate metadata, validating citations, converting DOIs to BibTeX, or ensuring reference accuracy in scientific writing. Provides tools for paper discovery, metadata extraction, BibTeX formatting, and citation validation."
...
Consider adding diagrams using the **scientific-schematics** skill (e.g., citation workflow diagrams, search methodology flowcharts). Generate via:
