...
description: "Write comprehensive clinical reports including case reports, diagnostic reports, clinical trial reports, and patient documentation. Use when creating CARE-compliant case reports, radiology/pathology/lab diagnostic reports, ICH-E3 clinical study reports, SAE reports, SOAP notes, H&P documents, or discharge summaries. Includes templates, regulatory compliance (HIPAA, FDA, ICH-GCP), and validation tools."
...
Include at least 1 AI-generated figure per report using the **scientific-schematics** skill (e.g., patient timelines, diagnostic algorithms, CONSORT flow diagrams, treatment workflows). Generate via:
